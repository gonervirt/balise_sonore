...
En agissant Comme un professionel ecrivant des manuel utilisateur,  Peux tu ecrire une documentation utilisateur en francais, qui n'a ps besoin de comprendre les developpement interne, un manuel detaillée dans un nouveau fichier .md qui explique comment gérer la balise sonore via le site web, en mettant des capture ecran pour donner les explication, en laissant un indiquant le besoin de chnager le mot de passe eet en laissant un espace pour ecrire le nouveau mot de passe, en indiquant comment ajouter de nouveau message (ajout du fichier sur la carte sd et modification via le site web. Cela doit etre court efficace, et agreable a utiliser.